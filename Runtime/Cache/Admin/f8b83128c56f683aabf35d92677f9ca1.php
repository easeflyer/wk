    ...
    <script type="text/javascript">
        function createop(_v, _r) {
            return "<a href='index.php?g=admin&m=Ehc&a=edit&id=" + _r.id + "' class='easyui-linkbutton' data-options='iconCls:\"icon-vcard_edit\"'>编辑</a>\n\
                                        <a href='javascript:void(0)' class='easyui-linkbutton'   data-options='iconCls:\"icon-vcard_edit\"'>删除</a>";
        }
...
<body>
    <div class="easyui-panel" data-options="
        ...
        <div id="toolbar">
            <a href="javascript:void(0)"" class=" easyui-linkbutton" data-options="plain:true,iconCls:'icon-vcard_add'"
                disabled>添加矿机</a>
        </div>
    </div>
</body>
