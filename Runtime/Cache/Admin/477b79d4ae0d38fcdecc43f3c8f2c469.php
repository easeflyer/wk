...
a{text-decoration:none; color:#000}
    ...
    <body class="easyui-layout">
        <div data-options="region:'north',split:true" style="height:100px; background:url('__SKIN__images/adminimage/topbg.jpg') no-repeat center">
            ...
            <a href="__APPURL__admin-public-logout" class="easyui-linkbutton" data-option="iconCls:'icon-application_home',plain:true" style="float:right; margin-right:88px; margin-top:10px;"target="_blank">退出登录（<?php echo (session('username')); ?>）</a>
        </div>
