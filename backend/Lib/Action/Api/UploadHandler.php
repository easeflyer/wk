...
class UploadHandler
{
    ...
    public function __construct($idnumber,$options = null, $initialize = true, $error_messages = null)
    {
        ...
        $this->options = array(
            ...
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'file', // 这里必须和前端 input name 一致
    ...
    public function getFileName(){
        $side = $this->get_query_param('side');
        return $this->idnumber."_".$side;
    }
